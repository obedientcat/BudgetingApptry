...
var budgetController = (function () {
    ...
    var recalcCategorySpent = function () {
        ...
        data.allItems.exp.forEach(function (e) {
            var cat = normalizeCategory(e.category);
            if (!cat) return;
...
var c = normalizeCategory(e.category);
    ...
    return {
        ...
        deleteCategory: function (category) {
            ...
            // move any existing expenses in this category to blank ('')
            data.allItems.exp.forEach(function (e) {
...
var UIController = (function () {
    ...
    var DOMstrings = {
        ...
        inputCategoryWrap: '.add__category-wrap',
        inputSecondaryHint: '.add__hint--left',
    ...
    return {
        ...
        syncCategorySelector: function (isAdvanced) {
            ...
            setHidden(DOMstrings.inputCategoryWrap, !show);
            setHidden(DOMstrings.inputCategory, !show);
            setHidden(DOMstrings.inputSecondaryHint, !show);
        },
